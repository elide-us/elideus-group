"""Users public registry bindings."""
...
def list_public_request() -> DBRequest:
  return _request("db:users:public:list_public:1")


def list_reported_request() -> DBRequest:
  return _request("db:users:public:list_reported:1")


def get_public_files_request() -> DBRequest:
  return _request("db:users:public:get_public_files:1")
