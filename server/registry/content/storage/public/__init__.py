...
def list_public_request() -> DBRequest:
  return _request("db:content:storage.public:list_public:1")


def list_reported_request() -> DBRequest:
  return _request("db:content:storage.public:list_reported:1")


def get_public_files_request() -> DBRequest:
  return _request("db:content:storage.public:get_public_files:1")
