...
from .services import (
  ...
  service_objects_upsert_component_v1,
...
DISPATCHERS: dict[tuple[str, str], callable] = {
  ...
  ("get_component_tree", "1"): service_objects_get_component_tree_v1,
  ("list_components", "1"): service_objects_list_components_v1,
  ("get_component_detail", "1"): service_objects_get_component_detail_v1,
  ("upsert_component", "1"): service_objects_upsert_component_v1,
