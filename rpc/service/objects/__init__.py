...
from .services import (
  ...
  service_objects_get_property_catalog_v1,
  service_objects_get_resolved_properties_v1,
  service_objects_delete_type_v1,
  service_objects_delete_component_property_v1,
  service_objects_delete_tree_node_property_v1,
  ...
  service_objects_upsert_component_property_v1,
  service_objects_upsert_tree_node_property_v1,
...
DISPATCHERS: dict[tuple[str, str], callable] = {
  ...
  ("get_property_catalog", "1"): service_objects_get_property_catalog_v1,
  ("get_resolved_properties", "1"): service_objects_get_resolved_properties_v1,
  ("upsert_component_property", "1"): service_objects_upsert_component_property_v1,
  ("upsert_tree_node_property", "1"): service_objects_upsert_tree_node_property_v1,
  ("delete_component_property", "1"): service_objects_delete_component_property_v1,
  ("delete_tree_node_property", "1"): service_objects_delete_tree_node_property_v1,
