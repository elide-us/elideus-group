...
async def system_routes_get_routes_v1(request: Request) -> RPCResponse:
...
async def system_routes_set_route_V1(request: Request) -> RPCResponse:
...
async def system_routes_delete_route_v1(request: Request) -> RPCResponse:
  rpc_request: RPCRequest = get_rpcrequest_from_request(request)
