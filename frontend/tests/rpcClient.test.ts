...
import { fetchVersion, fetchHostname, fetchRepo, fetchFfmpegVersion } from '../src/rpc/system/vars';
import { fetchHome, fetchRoutes } from '../src/rpc/system/links';
...
describe('rpcClient', () => {
    it('fetchVersion posts correct request', async () => {
        ...
        expect(mockedPost).toHaveBeenCalledWith('/rpc', expect.objectContaining({ op: 'urn:system:vars:get_version:1' }), expect.anything());
    ...
    it('fetchHostname posts correct request', async () => {
        ...
        expect(mockedPost).toHaveBeenCalledWith('/rpc', expect.objectContaining({ op: 'urn:system:vars:get_hostname:1' }), expect.anything());
    ...
    it('fetchRepo posts correct request', async () => {
        ...
        expect(mockedPost).toHaveBeenCalledWith('/rpc', expect.objectContaining({ op: 'urn:system:vars:get_repo:1' }), expect.anything());
    ...
    it('fetchFfmpegVersion posts correct request', async () => {
        ...
        expect(mockedPost).toHaveBeenCalledWith('/rpc', expect.objectContaining({ op: 'urn:system:vars:get_ffmpeg_version:1' }), expect.anything());
    ...
    it('fetchHome posts correct request', async () => {
        ...
        expect(mockedPost).toHaveBeenCalledWith('/rpc', expect.objectContaining({ op: 'urn:system:links:get_home:1' }), expect.anything());
    ...
    it('fetchRoutes posts correct request', async () => {
        ...
        expect(mockedPost).toHaveBeenCalledWith('/rpc', expect.objectContaining({ op: 'urn:system:links:get_routes:1' }), expect.anything());
