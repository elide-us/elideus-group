...
import { rpcCall, FrontendLinksHome2, FrontendLinksRoutes2 } from '../../../shared/RpcModels';

export const fetchHome = (payload: any = null): Promise<any> => rpcCall('urn:frontend:links:get_home:1', payload);
export const fetchRoutes = (payload: any = null): Promise<any> => rpcCall('urn:frontend:links:get_routes:1', payload);
