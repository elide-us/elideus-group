...
<EditBox
value={r.path}
onCommit={(val) => updateRoute(idx, "path", val)}
width="95%"
/>
</TableCell>
<TableCell sx={{ width: "30%" }}>
<EditBox
value={r.name}
onCommit={(val) => updateRoute(idx, "name", val)}
width="95%"
/>
</TableCell>
...
<EditBox
value={r.icon ?? ""}
onCommit={(val) => updateRoute(idx, "icon", val)}
width="95%"
/>
</TableCell>
...
<EditBox
value={r.sequence}
onCommit={(val) => updateRoute(idx, "sequence", val)}
width="95%"
/>
</TableCell>
